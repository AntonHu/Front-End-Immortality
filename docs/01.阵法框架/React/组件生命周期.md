...
本章节将探究React组件的生命周期是如何运转的，按照组件的初始化、挂载、更新、最后卸载的完整周期，找到对应源码的执行逻辑，进行原理的解读。
...
![1739807762595](https://cdn.jsdelivr.net/gh/antonhu/picx-images-hosting/picGo/1739807762595.jpg)
